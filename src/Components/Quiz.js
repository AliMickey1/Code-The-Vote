      ...
      questions: [
        {
          ...
          funFact:
            "They fund election administration and security through the federal budget.",
          answers: [
        ...
        },
        {
          ...
          funFact: "Federal Judges oversee such cases.",
          answers: [
      ...
      questions: [
        {
          ...
          funFact:
            "Gerrymandering is manipulating electoral district boundaries to favor a particular political party.",
          answers: [
        ...
        },
        {
          ...
          funFact:
            "Voter suppression involves intentionally making it difficult for certain groups to vote.",
          answers: [
