...
const Quiz = () => {
  ...
  useEffect(() => {
    ...
    const data = [
      {
        question: "What role do Presidents play in election administration and security?",
        answers: [
          { text: "They oversee state elections.", isCorrect: false },
          { text: "They fund election administration and security through the federal budget.", isCorrect: true },
          { text: "They directly count the votes.", isCorrect: false },
          { text: "They have no influence on elections.", isCorrect: false }
        ]
      },
      {
        question: "Who has the authority to hear cases about fair representation and access to the ballot box?",
        answers: [
      ...
      {
        question: "What percentage of U.S. adults say they experience stress as a result of the possibility of a mass shooting?",
        answers: [
      ...
      {
        question: "Which demographic group is more likely to experience stress often or constantly related to the possibility of a mass shooting?",
        answers: [
      ...
      {
        question: "Which places do U.S. adults commonly stress about the possibility of a mass shooting occurring?",
        answers: [
          { text: "Public event, mall, school, or university", isCorrect: true },
      ...
      {
        question: "What role can Presidents play in shaping public trust in elections?",
        answers: [
          { text: "They have no role.", isCorrect: false },
          { text: "They can use their platform to promote election integrity or misinformation.", isCorrect: true },
      ...
      {
        question: "According to the survey, what percentage of parents live in fear that their children will be victims of a mass shooting?",
        answers: [
      ...
      {
        question: "What is a significant factor that Hispanic and African American adults struggle with more than white non-Hispanic adults regarding stress from mass shootings?",
        answers: [
